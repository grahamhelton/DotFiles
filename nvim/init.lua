...
-- Go to main editing window (skip terminal and file browser)
vim.keymap.set('n', '<leader>gh', function()
  for _, win in ipairs(vim.api.nvim_list_wins()) do
    ...
    -- Skip terminal, neo-tree, and other special buffers
    if buf_type == '' and file_type ~= 'neo-tree' and not buf_name:match 'crush_terminal' then
      vim.api.nvim_set_current_win(win)
      return
    end
  end
end, { desc = '[G]o to main editing window ([H]ome)' })
...
local function toggle_crush_terminal()
  ...
  if crush_buf and vim.api.nvim_buf_is_valid(crush_buf) then
    ...
    -- Start terminal with crush command using full path
    vim.fn.termopen('/home/graham/go/bin/crush', {
      on_exit = function()
  ...
  -- Set window-local options to make it look like a proper terminal
...
vim.keymap.set('n', '<leader>ga', function()
  ...
  -- If no AI terminal found, create one
...
vim.keymap.set('n', '<C-_>', _G.toggle_floating_terminal, { desc = 'Toggle floating terminal' })
vim.keymap.set('n', '<leader>tt', _G.toggle_floating_terminal, { desc = 'Toggle floating terminal (test)' })
vim.keymap.set('t', '<C-/>', '<C-\\><C-n><cmd>lua toggle_floating_terminal()<CR>', { desc = 'Toggle floating terminal from terminal mode' })
vim.keymap.set('t', '<C-_>', '<C-\\><C-n><cmd>lua toggle_floating_terminal()<CR>', { desc = 'Toggle floating terminal from terminal mode' })
